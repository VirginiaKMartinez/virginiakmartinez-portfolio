...
export default {
  ...
  overview: {
    problem: {
      title: "Le problème",
      text:
        "Plusieurs équipes livraient des fonctionnalités avec des incohérences UI et de la duplication. Les prototypes seuls ne suffisaient pas aux devs.",
    },
    goals: {
      title: "Objectifs",
      items: [
  ...
  results: {
    ...
    notes: [
      "Vocabulaire partagé design & dev",
